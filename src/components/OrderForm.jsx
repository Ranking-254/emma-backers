...
const OrderForm = () => {
  ...
  return (
    <section className="bg-white py-20 px-8" id="order-form">
      <div className="max-w-3xl mx-auto border border-gray-100 p-10 shadow-sm">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-4 font-light italic">Tell us about your celebration, and we’ll bake the centerpiece.</p>
        </div>
        ...
        <form onSubmit={handleWhatsAppSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Preferred Date */}
          <div className="flex flex-col gap-2">
            <label className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Collection Date</label>
            <input 
              name="date"
              type="date" 
              required
          ...
          {/* Cake Message */}
          <div className="flex flex-col gap-2 md:col-span-2">
            <label className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Message on Cake</label>
            <input 
              name="message"
              type="text" 
              onChange={handleChange}
